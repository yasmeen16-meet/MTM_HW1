...
///eurovisionDestroy function:
///destroying a whole eurovision program: state & judges
...
///eurovisionAddJudge function:
///adding a new judge to the eurovision program, including his votes details
